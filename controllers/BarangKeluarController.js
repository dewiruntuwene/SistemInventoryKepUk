...
export const createBarangKeluar = async(req, res) =>{
    const { barangId, id_barang, nama_barang, total_stock, jenis_barang, gambar_barang, harga_barang, jumlah_barang, tanggal_keluar, tanggal_masuk, kode_barang } = req.body;
