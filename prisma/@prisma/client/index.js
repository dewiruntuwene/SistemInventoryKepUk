...
const config = {
  generator: {
    ...
    previewFeatures: [],
    sourceFilePath:
      "D:\\Magang KTP\\SistemInventoryKepUk\\prisma\\schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
...
if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
  const alternativePaths = ["prisma/@prisma/client", "@prisma/client"];
